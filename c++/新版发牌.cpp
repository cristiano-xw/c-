...
private:
	...
	void show(int num,bool hide=false); 
...
void poker::show(int num,bool hide) 
{
	...
	if(hide)  cout<<"";
	else if(gamers[num][0].num==A) cout<<"A ";	 
	...
	if(getscore(gamers[num],numcards[num])>21)
		cout<<endl<<name[num]<<"(超过21点啦 ！ 结束啦)!"<<endl; 
}
